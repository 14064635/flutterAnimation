...
const double _kDragSizeFactorLimit = 1.4;

// When the scroll ends, the duration of the refresh indicator's animation
// to the RefreshIndicator's displacement.
const Duration _kIndicatorSnapDuration = Duration(milliseconds: 300);
...
//  导航相关
  ...
  final opacityTween = Tween(begin: 1.0, end: 0.0);
...
//    显示出导航
  ...
  Widget build(BuildContext context) {
    ...
    final showIndeterminateIndicator = _mode == RefreshIndicatorMode.refresh ||
